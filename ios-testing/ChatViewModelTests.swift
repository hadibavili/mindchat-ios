...
final class ChatViewModelTests: XCTestCase {
    ...
    func test_loadSettings_networkOverridesCachedValues() async {
        mockSettings.cachedSettings = MockSettingsService.makeSettings(model: "gpt-4.1", plan: .pro)
        mockSettings.networkSettings = MockSettingsService.makeSettings(model: "gpt-4.1-mini", plan: .free)
